export const GitHubNFT_CONTRACT_ADDRESS =
  "0x046296a0E28656412573dcf94355F0B9E1c11de8";

export const GitHubNFT_CONTRACT_ABI = [
  {
    inputs: [
      { internalType: "address", name: "_reclaimAddress", type: "address" },
    ],
